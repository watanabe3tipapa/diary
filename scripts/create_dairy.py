...
"""
Usage:
  python scripts/create_dairy.py [--dir dairy] [--date YYYY-MM-DD] [--template templates/dairy.md]
...
def main():
    ...
    p.add_argument("--dir", default="dairy")
    p.add_argument("--date", default=None)
    p.add_argument("--template", default="templates/dairy.md")
    args = p.parse_args()
